...
выводятся заглушки для температуры на первом и втором этажах, температуры на
улице и в колодце. Уровень воды берётся из последнего свежего измерения YDB; при
