...
Кнопка «Румянцево» открывает отдельный экран показателей дома. Пока на нём
температура на первом этаже читается с Nest Thermostat через официальный Google
Smart Device Management API. Для остальных температур пока выводятся заглушки.
